...
class OnModifiedController:
    ...
    def event_handler(self):
        ...
        # TODO Need waiting for update aws resource
        aws_redis = self.redis_manager.on_event_handler({"onModifed": "True"})
        self.cfg_manager.replace_namespaced_config_map(self.cfg_name, {
            "python": "Awesome onModifed"
        })
